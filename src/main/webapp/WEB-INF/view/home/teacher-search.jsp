            ...
            $(function () {
                $("#input_query").autocomplete({
                    source: function (request, callback) {
                        $.ajax({
                            type: "GET",
                            url: "${pageContext.request.contextPath}/teacher-autoComplete?query=" + $("#input_query").val(),
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <form id="searchForm" action="${pageContext.request.contextPath}/search-teacher" method='GET' class="mt-4 pt-2" >
                                            <div class="auth-content my-auto">
                                                ...
                                                <div class="mb-4">
                                                    <input name="schoolName" type="hidden" class="form-control" id="idTeacherName">
